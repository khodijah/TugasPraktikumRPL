...
public class MenuPemilik extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ZAHRA Studio Musik");
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
        try{
            String namafile= "./src/ZAHRA_Studio_Musik/laporan.jasper";
            koneksi();
            HashMap param=new HashMap();
            param.clear();
            JasperPrint JPrint = JasperFillManager.fillReport(namafile, param, conn);
            JasperExportManager.exportReportToPdfFile(JPrint, "C:\\Users\\Khodijah Azzahra\\Documents\\djLaporan.pdf");
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler C:\\Users\\Khodijah Azzahra\\Documents\\djLaporan.pdf");
